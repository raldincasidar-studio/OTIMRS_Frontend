...
async function saveAttraction() {
    await makeRequest.post(`/tourist-attractions/update/${route.params.id}`, {
        name: name.value,
    ...
    toast.fire({
        title: 'Tourist Attraction updated',
        icon: 'success'
    })
...
onMounted(() => {
    ...
    makeRequest.get(`/tourist-attractions/${id}`).then(res => {
        if (res.data.success) {
            ...
            opening_hours.value = res.data.data.opening_hours;
            admission_fee.value = res.data.data.admission_fee;
            image_url.value = res.data.data.image_url;
            rating.value = res.data.data.rating;
            latitude.value = res.data.data.latitude;
            longitude.value = res.data.data.longitude;
