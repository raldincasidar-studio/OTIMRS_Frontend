...
onMounted( () => {
    ...
    makeRequest.get(`/tourist-attractions/${route.params.id}`).then(res => {
        if (res.data.success) {
                    ...
                    <div class="container">
                        ...
                        <div class="introduction text-center">
                            ...
                            <p class="text-center tag">
                                <span>#{{ attractions_info.category }}</span>
                            </p>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex">
                                            ...
                                            <div class="content">
                                                <h2>Opening Hours</h2>
                                                <p>{{ attractions_info.opening_hours }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex">
                                            ...
                                            <div class="content">
                                                <h2>Admission Fee</h2>
                                                <p>{{ attractions_info.admission_fee }}</p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
